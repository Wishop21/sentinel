...
async function createSingleThreadRuntime() {
	const { default: createWasmModuleSingleThread } = await import("./base-release-CAE1WyMd.js");
...
async function createMultiThreadRuntime(options) {
	const { default: createWasmModuleMultiThread } = await import("./pthreads-release-8m90FMpw.js");
